  ...
  return (
    <>
      <Head>
        ...
        <meta
          name="description"
          content="Welcome to Vectorize, your gateway to flawless conversions from pixel to vector. Experience the power of precision and quality in every transformation."
        />
      </Head>
      <ConfigureCodeBanner
      ...
      <HomeLayout>
        <Box position="relative" display="flex" flex={{ lg: '0 0 485px' }} height={{ base: '180px', lg: 'auto' }}>
          <Image
            flex="1"
            src={
              'https://images.unsplash.com/flagged/photo-1562599838-8cc871c241a5?crop=entropy&cs=tinysrgb&fit=max&fm=jpg&ixid=M3w0NjA3NjB8MHwxfHNlYXJjaHwxfHxwaXhlbHxlbnwwfHx8fDE2OTgzMDc3MTB8MA&ixlib=rb-4.0.3&q=80&w=1080'
            }
            alt="Dinner"
            objectFit="cover"
          ...
          <Box position="absolute" top="0" backgroundColor="rgba(0,0,0,0.6)" width="100%" py="2">
            <Text align="center" fontSize="sm" color="white">
              Photo by{' '}
              <Link
                href="https://unsplash.com/@umby?utm_source=roq-generator&utm_medium=referral"
                isExternal
                color="teal.200"
              >{`Umberto`}</Link>{' '}
              on{' '}
        ...
        >
          <Box>
            ...
            <Text size="2xl" mb={{ base: '32px', lg: '48px' }} color="base.content" opacity="0.6">
              {`Welcome to Vectorize, your gateway to flawless conversions from pixel to vector. Experience the power of precision and quality in every transformation.`}
            </Text>
            <Box
